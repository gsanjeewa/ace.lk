                  ...
                  <table id="example2" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      if(isset($_GET['effective_date']))
                      {
                        ...
                        $statement = $connect->prepare("SELECT a.employee_no, a.bank_id, a.employee_id, a.net FROM payroll_items a INNER JOIN payroll b ON a.payroll_id=b.id WHERE a.status=3 AND b.date_from='".$effective_date."' ORDER BY a.bank_id ASC, cast(a.employee_no as int) ASC");
                        $statement->execute();
