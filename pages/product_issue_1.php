...
if (isset($_POST['add_save'])){
  ...
  $query = "
  INSERT INTO inventory_stock(id, product_id, size, color, gender, location_id, qty, unit_price, status, ref_no, employee_id, total)
  VALUES (:id, :product_id, :size, :color, :gender, :location_id, :qty, :unit_price, :status, :ref_no, :employee_id, :total)
  ";
...
?>
    ...
    <section class="content">
      ...
      <br />
      <div align="right">
        <a href="/inventory/issue_product/1" class="btn btn-info btn-xs">Create</a>
      </div>
      <br />
