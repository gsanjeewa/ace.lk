...
if (checkPermissions($_SESSION["user_id"], 72) == "false") {
        ...
        <div class="row">          
          <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <div class="card-body">  
                  <?php
                  $query = 'SELECT * FROM death_donation ORDER BY id DESC';
