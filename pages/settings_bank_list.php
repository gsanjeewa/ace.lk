...
if(isset($_POST['add_new']))
{
  ...
  $statement = $connect->prepare("SELECT bank_name FROM bank_name WHERE bank_name=:bank_name");
  ...
  if (!$error) {
    $data = array(
        ':bank_name'  =>  strtoupper($_POST['bank_name']),
        ':bank_no'    =>  $_POST['bank_code'],
    );
   
    $query = "
    INSERT INTO `bank_name`(`bank_name`, `bank_no`) VALUES (:bank_name, :bank_no)
    ";
...
if(isset($_POST['insert']))
{
    ...
    $query = "UPDATE `bank_name` SET `bank_name`=:bank_name, `bank_no`=:bank_no WHERE `id`=:id";
                    ...
                    <tbody>
                      ...
                      foreach($result as $row)
                      {
                        ...
                        <tr>
                            ...
                            <td><center><?php echo $row['bank_no'];?></center></td>
                            <td>
                              <center>
