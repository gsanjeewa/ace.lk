...
<div class="card-body">
    ...
    {
        $eid=$_POST['edit_id4'];
        $sql2="SELECT * from shifts_allowance where id=:eid";
                ...
                <form action="" class="form-sample" method="post" enctype="multipart/form-data" id="add_bank_form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="allowance" value="<?php  echo $row->allowance;?>" class="form-control text-uppercase" id="allowance">
                            </div>
                        </div>
                    </div>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="add_bank_form">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <label class="col-sm-12 pl-0 pr-0">Shifts Allowance</label>
                    <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" name="allowance" class="form-control text-uppercase" id="allowance">
                    </div>
                </div>
            </div>
