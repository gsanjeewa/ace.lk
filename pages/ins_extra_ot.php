...
if (isset($_POST['add_save'])){
  ...
  $query = "
  INSERT INTO `attendance`(`employee_id`, `department_id`, `start_date`, `end_date`, `extra_ot_hrs`)
  VALUES (:employee_id, :department_id, :start_date, :end_date, :extra_ot_hrs)
  ";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Extra OT</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            if(isset($_GET['dep_id'])):
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title">Extra OT - <?php echo $row['department_name'].'-'.$row['department_location']; ?></h3>
                </div>
                  <!-- /.card-header -->
                <div class="card-body">
...
$(function () {
  ...
  $('#formattendance').validate({
    rules: {
      ...
      extra_ot_hrs: {required: true, number: true},
    },
...
function load_extra(department_id = '' , )
{
  ...
  $.ajax({
    url:"/employee_no",
    method:"POST",
    data:{department_id:department_id,start_date:start_date,request:12},
    dataType: 'json',
    ...
    success:function(response)
    {
      ...
      if(response.length > 0)
      {
        for(var count = 0; count < response.length; count++)
        {
          ...
          html += '<td style="width:20%; text-align:right;">'+response[count].extra_ot_hrs+'</td>';                     
          html += '</tr>'; 
          serial_no++;            
        }
      }
