                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php                     
                        ...
                        $statement = $connect->prepare("SELECT a.employee_id, a.employer_etf, a.basic_epf, a.employee_no, b.date_from, b.date_to, a.no_of_shift FROM payroll_items a INNER JOIN payroll b ON a.payroll_id=b.id WHERE b.date_from='".$effective_date."' AND employer_etf > 0 ORDER BY a.id DESC");
                        $statement->execute();
                      ...
                      {
                        $query_emp = 'SELECT e.nic_no, e.surname, e.initial, j.employee_no, j.join_date FROM employee e INNER JOIN join_status j ON e.employee_id = j.employee_id WHERE e.employee_id="'.$row['employee_id'].'" ORDER BY e.employee_id DESC';
