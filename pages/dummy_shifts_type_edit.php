...
<div class="card-body">
    ...
    {
        $eid=$_POST['edit_id4'];
        $sql2="SELECT * from d_shifts_type where id=:eid";
                ...
                <form action="" class="form-sample" method="post" enctype="multipart/form-data" id="add_bank_form">
                    ...
                    <div class="row">
                        <div class="form-group clearfix col-md-12">
                            ...
                            <input type="radio" id="12_shifts" name="shifts_type" value="12" <?php if ($row->shifts_type==12) { echo "checked";} ?>>
                            <label for="12_shifts">12 Shifts
                            </label>
                            </div>
                            <div class="icheck-primary d-inline">
                            <input type="radio" id="8_shifts" name="shifts_type" value="8" <?php if ($row->shifts_type==8) { echo "checked";} ?>>
                            <label for="8_shifts">8 hifts
                            </label>
                            </div>                                       
                        </div>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="add_bank_form">
            ...
            <div class="row">
                <div class="form-group clearfix col-md-12">
                    <div class="icheck-primary d-inline">
                    <input type="radio" id="12_shifts" name="shifts_type" value="12" checked>
                    <label for="12_shifts">12 Shifts
                    </label>
                    </div>
                    <div class="icheck-primary d-inline">
                    <input type="radio" id="8_shifts" name="shifts_type" value="8">
                    <label for="8_shifts">8 Shifts
                    </label>
                    </div>                                       
                </div>
