...
<div class="card-body">
    ...
    {
        $eid=$_POST['edit_id4'];
        $sql2="SELECT * from sector where id=:eid";
                ...
                <form action="" class="form-sample" method="post" enctype="multipart/form-data" id="add_bank_form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-sm-12 pl-0 pr-0">Sector Name</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="sector_name" value="<?php  echo $row->sector;?>" class="form-control text-uppercase" id="sector_name">
                            </div>
                        </div>
                    </div>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="add_bank_form">
            <div class="row">
                <div class="form-group col-md-12">
                    <label class="col-sm-12 pl-0 pr-0">Sector Name</label>
                    <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" name="sector_name" class="form-control text-uppercase" id="sector_name">
                    </div>
                </div>
            </div>
