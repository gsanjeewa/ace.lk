...
if (isset($_POST['add_new'])) {
  if (checkPermissions($_SESSION["user_id"], 83) == "false") {
      $_SESSION["msg"] = '<div class="alert alert-dismissible alert-danger bg-gradient-danger text-white"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="fas fa-fw fa-times"></i>You do not have permissions.</div>'; 
      header('location:/dummy/half_days');   
      exit();
  }
  ...
  if (!$error) {
      ...
      try {
          $query = "
              INSERT INTO d_half_days (department_id, position_id)
...
if(isset($_POST['insert']))
{
    ...
    $query = "UPDATE `d_half_days` SET `department_id`=:department_id, `position_id`=:position_id WHERE `id`=:id";
...
if (isset($_POST['shift_disable'])){
  ...
  $query = "UPDATE `d_half_days` SET `status`=:status WHERE `id`=:id";
          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Halt Days</h3>
                ...
                <div class="card-body">  
                  ...
                  $query = 'SELECT b.department_name, b.department_location, a.id, a.status, c.position_abbreviation FROM d_half_days a INNER JOIN department b ON a.department_id=b.department_id INNER JOIN position c ON a.position_id=c.position_id ORDER BY b.department_name ASC';
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Half Days</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body" id="info_update4">
            <?php @include("/edit_half_days");?>
          </div>
