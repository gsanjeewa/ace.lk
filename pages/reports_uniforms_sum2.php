...
<div class="content-header">
   ...
   <h3 align="center">Uniforms Summary</h3>
   <br />
   <div class="row">
  ...
  function fill_datatable()
  {
   ...
   "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
    ...
    drawCallback:function(settings)
    {
     ...
     $('#total_paid_amount').html(settings.json.total_paid_amount);
     $('#total_remaining_amount').html(settings.json.total_remaining_amount);        
    },
    dom: 'lBfrtip',
    buttons: [
      {
        extend:'excelHtml5',
        title:'Uniforms_Summary',
        footer:true
      }
   ]
   });
