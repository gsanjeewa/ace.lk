...
$end_date=date('Y-m-d', strtotime("last day of -1 month"));
  ...
  $query = "
  INSERT INTO `attendance_merc`(`employee_id`, `department_id`, `position_id`, `start_date`, `end_date`, `no_of_shifts`)
  VALUES (:employee_id, :department_id, :position_id, :start_date, :end_date, :no_of_shifts)
  ";
          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Add Marc Attendance</h3>                
                </div>
                  <!-- /.card-header -->
                <div class="card-body">
                  <?php
...
echo date_create("first day of -1 month")->format('Y-m-d');*/
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            <label for="employee_name">Name with initial</label>
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="department_id">Institution ID</label>
                            <input type="text" class="form-control" id="department_id" name="department_id" autocomplete="off"> 
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="institution_name" name="institution_name" readonly>             
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="position_id" name="position_id" autocomplete="off">
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="position_name" name="position_name" readonly>             
                          </div>
                        </div>
                      </div>
                   ...
                   <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="start_date" class="control-label">Marcantile Holidays</label>
