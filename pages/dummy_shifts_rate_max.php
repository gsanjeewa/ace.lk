...
if (isset($_POST['add_new'])) {
    if (checkPermissions($_SESSION["user_id"], 83) == "false") {
        $_SESSION["msg"] = '<div class="alert alert-dismissible alert-danger bg-gradient-danger text-white"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="fas fa-fw fa-times"></i>You do not have permissions.</div>'; 
        header('location:/dummy/shifts_rate_max');   
        exit();
    }
    ...
    if (!$error) {
        ...
        try {
            $query = "
                INSERT INTO d_shifts_rate_max (department_id, position_id, shifts)
...
if(isset($_POST['insert']))
{
    ...
    $query = "UPDATE `d_shifts_rate_max` SET `department_id`=:department_id, `position_id`=:position_id, `shifts`=:shifts WHERE `id`=:id";
...
if (isset($_POST['shift_disable'])){
    ...
    $query = "UPDATE `d_shifts_rate_max` SET `status`=:status WHERE `id`=:id";
          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <div class="card-body">  
                  ...
                  $query = 'SELECT b.department_name, b.department_location, a.shifts, a.id, a.status, a.position_id FROM d_shifts_rate_max a INNER JOIN department b ON a.department_id=b.department_id ORDER BY b.department_name ASC';
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Shifts Rate Max</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body" id="info_update4">
            <?php @include("/edit_shifts_rate_max");?>
          </div>
