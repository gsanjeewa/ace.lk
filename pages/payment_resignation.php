          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Resignation</h3>                
                </div>
                  <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      if(isset($_GET['effective_date']))
                      {
                        ...
                        $statement = $connect->prepare("SELECT b.employee_no, c.surname, c.initial, a.net_amount, b.join_id, h.bank_no, h.branch_no, h.account_no, h.holder_name FROM resignation a 
                          ...
                          INNER JOIN payroll j ON a.inventory_deduction=j.id
                          WHERE DATE_FORMAT(j.date_from,'%Y-%m') = '".$effective_date."' ORDER BY h.bank_no ASC, cast(b.employee_no as int) ASC");
                        $statement->execute();
                        ...
                        foreach($result as $row)
                        {
                          ...
                          $with_decimal=round($row['net_amount'],2);
