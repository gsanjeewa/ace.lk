...
if (isset($_POST['add_save'])){
  ...
  $query = "
  INSERT INTO inventory_create_invoice(invoice_no, location_id, employee_id)
  VALUES (:invoice_no, :location_id, :employee_id)
  ";
      ...
      },
      {
        ...
        "render": function(data, type, row, meta) {
          if (type === 'display' || type === 'filter') {
            // Check if data is empty or NaN
            if (data === null || isNaN(parseFloat(data))) {
              return ''; // Return empty string if data is empty or NaN
            } else {
