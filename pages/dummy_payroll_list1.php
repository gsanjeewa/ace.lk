...
if (isset($_POST['add_save'])){
  ...
  if (checkPermissions($_SESSION["user_id"], 29) == "false") {
    ...
    $_SESSION["msg"] ='<div class="alert alert-dismissible alert-danger bg-gradient-danger text-white"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="fas fa-fw fa-times"></i>You do not have permissions.</div>';
    header('location:/payroll_list/d_payroll');
    exit();
}
                            ...
                            <td>
                              <center>
                                ...
                                <?php else: ?>
                                    ...
                                    <!-- <button class="btn btn-sm btn-outline-danger" id="payslip" name="payslip" data-toggle="tooltip" data-placement="top" title="Payslip" type="submit"><i class="fa fa-money-bill"></i></button> -->
                                  </form>  
                                <?php endif ?>
