          ...
          <div class="col-md-6">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Print Pay Slip</h3>                
                </div>
                  <!-- /.card-header -->
                <div class="card-body">

                  
                  <form method="POST" target="_blank" id="add_deduction_form" action="/payroll_list/print_depatment">
                    <div class="col-md-12">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="ins_id" id="ins_id">
                    ...
                    <?php
                    $query="SELECT b.department_id, b.department_name, b.department_location FROM payroll_items a INNER JOIN department b ON a.department_id=b.department_id GROUP BY a.department_id ORDER BY b.department_name ASC";
