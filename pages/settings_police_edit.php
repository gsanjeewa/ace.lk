...
<div class="card-body">
    ...
    {
        $eid=$_POST['edit_id4'];
        $sql2="SELECT * from police where police_id=:eid";
        ...
        if($query2->rowCount() > 0)
        {
            ...
            {
                $_SESSION['editbid']=$row->police_id;        
                ?>
                ...
                <form action="" class="form-sample" method="post" enctype="multipart/form-data" id="add_bank_form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">Police Station</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="police_stn" id="police_stn" class="form-control text-uppercase" value="<?php echo $row->police;?>" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">OIC Mobile</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="oic_mobile" id="oic_mobile" class="form-control text-uppercase" value="<?php echo $row->oic_mobile;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">Office</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="office" id="office" class="form-control text-uppercase" value="<?php echo $row->office;?>" />
                            </div>
                        </div>
                ...
                <select class="form-control select2" style="width: 100%;" id="districts" name="districts">
                  ...
                  ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">Police Station</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="police_stn" id="police_stn" class="form-control text-uppercase"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">OIC Mobile</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="oic_mobile" id="oic_mobile" class="form-control text-uppercase" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-12 pl-0 pr-0">Office</label>
                            <div class="col-sm-12 pl-0 pr-0">
                                <input type="text" name="office" id="office" class="form-control text-uppercase" />
                            </div>
                        </div>
