...
if(isset($_POST["payroll_id"], $_POST["payroll_item_id"], $_POST["employee_id"]))
{
...
$delete_permision = array(
  ...
  $query = "
  DELETE FROM `payroll_items` WHERE `payroll_id`=:payroll_id AND `id`=:payroll_item_id AND `employee_id`=:employee_id
