...
if (isset($_POST['add_new'])) {
  if (checkPermissions($_SESSION["user_id"], 83) == "false") {
      $_SESSION["msg"] = '<div class="alert alert-dismissible alert-danger bg-gradient-danger text-white"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="fas fa-fw fa-times"></i>You do not have permissions.</div>'; 
      header('location:/dummy/shifts_type');   
      exit();
  }
  ...
  if (!$error) {
      ...
      try {
          $query = "
              INSERT INTO d_shifts_type (department_id, position_id, shifts_type)
              VALUES (:department_id, :position_id, :shifts_type)
          ";
...
if(isset($_POST['insert']))
{
    ...
    $query = "UPDATE `d_shifts_type` SET `department_id`=:department_id, `position_id`=:position_id, `shifts_type`=:shifts_type WHERE `id`=:id";
...
if (isset($_POST['shift_disable'])){
  ...
  $query = "UPDATE `d_shifts_type` SET `status`=:status WHERE `id`=:id";
          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Shifts Type</h3>
                ...
                <div class="card-body">  
                  ...
                  $query = 'SELECT b.department_name, b.department_location, a.id, a.status, c.position_abbreviation, a.shifts_type FROM d_shifts_type a INNER JOIN department b ON a.department_id=b.department_id INNER JOIN position c ON a.position_id=c.position_id ORDER BY b.department_name ASC';
                      ...
                      foreach($result as $row)
                      {
                       ...
                       elseif($row['status'] == 1): 
                        ...
                        <tr>
                            ...
                            <td><center><?php echo $row['shifts_type']; ?></center></td>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Shifts Type</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body" id="info_update4">
            <?php @include("/edit_shifts_type");?>
          </div>
