...
if (checkPermissions($_SESSION["user_id"], 89) == "false") {
...
{
  if (checkPermissions($_SESSION["user_id"], 87) == "false") {
    $_SESSION["msg"] ='<div class="alert alert-dismissible alert-danger bg-gradient-danger text-white"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="fas fa-fw fa-times"></i>You do not have permissions.</div>'; 
  ...
  $statement = $connect->prepare("SELECT branch_name FROM bank_branch WHERE branch_name=:branch_name");
  $statement->bindParam(':branch_name', $branch_name);
  $statement->execute(); 
  ...
  if (!$error) {
    $data = array(
        ...
        ':branch_no'    =>  $_POST['branch_code'],
    );
   
    $query = "
    INSERT INTO `bank_branch`(`bank_name_id`, `branch_name`, `branch_no`, `address`) VALUES (:bank_name_id, :branch_name, :branch_no, :address)
    ";
...
{
    if (checkPermissions($_SESSION["user_id"], 88) == "false") {
    ...
    $query = "UPDATE `bank_branch` SET `bank_name_id`=:bank_name_id, `branch_name`=:branch_name, `branch_no`=:branch_no, `address`=:address WHERE `id`=:id";
          ...
          <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <div class="card-body">  
                  ...
                  $query = 'SELECT a.id, b.bank_name, a.branch_name, a.branch_no, a.address FROM bank_branch a INNER JOIN bank_name b ON a.bank_name_id=b.id ORDER BY a.bank_name_id ASC ';
                    ...
                    <tbody>
                      ...
                      foreach($result as $row)
                      {
                        ...
                        <tr>
                            ...
                            <td><center><?php echo $row['branch_no'];?></center></td>
