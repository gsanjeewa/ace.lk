...
$column = array('');
$output='';
if(isset($_POST['effective_date'], $_POST['allowances_id']) && $_POST['effective_date'] != '' && $_POST['allowances_id'] != '' )
{
  $effective_date = date("Y-m", strtotime($_POST['effective_date']));

$query = "
SELECT e.initial, e.surname, j.employee_no, a.amount, p.position_abbreviation, e.employee_id
    ...
    WHERE DATE_FORMAT(a.effective_date,'%Y-%m') = '".$effective_date."' AND a.allowances_id='".$_POST['allowances_id']."' ORDER BY cast(j.employee_no as int) ASC
