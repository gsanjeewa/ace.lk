...
<body>
    ...
    {	
    	$statement = $connect->prepare('SELECT * FROM address WHERE status=0 ORDER BY id DESC LIMIT 1');
          	...
          	$query .= "SELECT a.grand_total, a.status, a.invoice_no, a.invoice_date, f.location FROM inventory_create_invoice_loc a 
    	...
    	?>
	    	<div class="page">
	    		...
	    		<div class="row">
			    	...
			    	WHERE a.loc_invoice_id ="'.$_POST['invoice_id'].'" ORDER BY a.id ASC';
	    				...
	    				<tfoot>
	    					<tr>
	    						...
	    						<th style="text-align:right;">	    							
	    							...
	    							$query = 'SELECT sum(a.total) AS sub_total FROM inventory_stock a INNER JOIN inventory_product b ON a.product_id = b.id WHERE a.loc_invoice_id ="'.$_POST['invoice_id'].'" ORDER BY a.id ASC';
