...
$statement = $connect->prepare("SELECT invoice_no FROM inventory_create_invoice_loc ORDER BY invoice_no DESC LIMIT 1");
                $statement->execute();
                ...
                if ($statement->rowCount()>0) {
                  foreach($result as $invoice_no){
                    ...
                    if ($expNum[0]=='S'.date('Y')) {
                      $ref_no='S'.date('Y').'-'.str_pad($expNum[1]+1, 4, "0", STR_PAD_LEFT);
                    }else{
                      $ref_no='S'.date('Y').'-'.str_pad(1, 4, "0", STR_PAD_LEFT);
                    }
                  }
                }
                else{
        ...
        <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control select2 location_id" style="width: 100%;" name="location_id" id="location_id">
                          ...
                          <?php
                          $query="SELECT * FROM inventory_location WHERE type=1 ORDER BY location ASC";
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control select2 sub_location_id" style="width: 100%;" name="sub_location_id" id="sub_location_id">
                          <option value="">Select Location</option>
                          <?php
