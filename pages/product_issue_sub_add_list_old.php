...
if (isset($_POST['add_save'])){
  ...
  $query = "
  INSERT INTO inventory_stock(id, product_id, size, color, gender, location_id, sub_location_id, qty, unit_price, status, total, loc_invoice_id)
  VALUES (:id, :product_id, :size, :color, :gender, :location_id, :sub_location_id, :qty, :unit_price, :status,  :total, :loc_invoice_id)
  ";
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="location_id" class="form-control" value="<?php echo $row["location_id"]; ?>" readonly><input type="text" class="form-control" value="<?php echo $row["location"]; ?>" readonly>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="sub_location_id" class="form-control" value="<?php echo $row["sub_location_id"]; ?>" readonly><input type="text" class="form-control" value="<?php echo $row["sub_location"]; ?>" readonly>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody id="post_data">
                          <tr><td colspan="6" class="text-center">Select Product</td></tr>
                      </tbody>
                        <tfoot>
                          <tr>
