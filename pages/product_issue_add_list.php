...
if (isset($_POST['add_save'])){
  ...
  $query = "
  INSERT INTO inventory_stock(id, product_id, size, color, gender, location_id, qty, unit_price, status, invoice_id, total)
  VALUES (:id, :product_id, :size, :color, :gender, :location_id, :qty, :unit_price, :status, :invoice_id, :total)
  ";
        ...
        <div class="row">          
          <div class="col-md-12">
            <div class="card card-success">
                  ...
                  {
                    $query = 'SELECT a.location_id, a.invoice_date, a.id, a.grand_total, a.status, f.location, a.invoice_no, a.employee_id, j.employee_no, p.position_abbreviation, e.surname, e.initial FROM inventory_create_invoice a 
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="employee_id" class="form-control" value="<?php echo $employee_epf.' '.$row['position_abbreviation'].' '.$row['surname'].' '.$row['initial']; ?>" readonly>
                      </div>
                    </div>
