...
<div class="book">
	...
	if(isset($_POST['effective_date']))
    {
    	...
    	$query = 'SELECT * FROM payroll_items a INNER JOIN payroll b ON a.payroll_id = b.id  WHERE b.date_from="'.$effective_date.'" AND (a.status=1 OR a.status=3) ORDER BY a.employee_no ASC, a.department_id ASC';
...
?>
	...
	<tr>
		...
		<th style="text-align: right;"><?php if ($total['total_uniforms'] !=0) : echo number_format($total['total_uniforms'],2); else: ; endif;?></th>
		...
		<th style="text-align: right;"><?php if ($total['total_death'] !=0) : echo number_format($total['total_death'],2); else: ; endif;?></th>
		<th></th>
